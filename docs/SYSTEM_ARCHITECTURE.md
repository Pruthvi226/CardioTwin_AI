...
## Data Flow
Raw CSV signal input moves through missing-value handling, filtering, normalization, windowing, quality scoring, feature extraction, and spectrogram generation.
...
## Inference Flow
The API and dashboard clean incoming signals, create windows, extract features, estimate confidence and uncertainty, then return a safe demo prediction.
